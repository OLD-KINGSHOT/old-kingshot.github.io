...
const EVENTS_INFO=[
 ...
 {g:'Event rotasi "spend -> hadiah" (kebanyakan 2 hari)', items:[
   ...
   {n:'Eternity\u2019s Reach',cat:'solo',freq:'berkala',what:'Event kompetitif SOLO 30 menit, dua mingguan, dan SELALU hari SELASA. Kamu dicocokkan ke medan berisi ~100 pemain lain menurut riwayat match, slot waktu, dan umur server. ⚠ WAJIB REGISTRASI minimal 15 menit sebelum medannya buka — tanpa itu kamu tak bisa ikut. Terlewat? JANGAN memaksa masuk; daftar saja ke slot berikutnya. Kecepatan menentukan, jadi siapkan dulu: slot march terbuka, jalur tech hafal, semua boost aktif sebelum mulai.'},
