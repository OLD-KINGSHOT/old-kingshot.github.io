...
const EVENTS_INFO=[
 {g:'Rutin (harian / mingguan)', items:[
   ...
   {n:'Mystic Trial',cat:'PvE \u00b7 mingguan',freq:'Rotasi dungeon mingguan',what:'Dungeon solo. Sumber Misty Crystal \u2192 Mithril (bottleneck crafting gear). Kerjakan tiap buka.'},
 ...
 {g:'Berkala / khusus', items:[
   ...
   {n:'Master System (Master Academy)',cat:'progresi \u00b7 update Apr 2026',freq:'permanen (gate Kingdom Progress)',what:'Quinn berpetualang ke Badlands \u2014 terima komisi Governor, selesaikan tantangan untuk merekrut MASTER yang pindah ke Master Academy di kotamu. Unlock per-kingdom (cek layar Kingdom Progress). Bonus patch: opsi tukar Truegold diskon 50% (limit mingguan).'},
...
const WEEKLY_GUIDE={
  ...
  allianceChampionship:'Tim didaftarkan R4/R5. F2P: daftar kalau diminta, hadir saat jam tanding, klaim reward partisipasi.',
