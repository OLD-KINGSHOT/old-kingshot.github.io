...
const PETS=[
  ...
  {n:'Lynx',w:1,day:'~55',role:'Utility',skill:'Comforting Embrace: pulihkan stamina (35 di Lv10 · 40 di Lv20 · 60 di skill maks), cooldown 23 JAM — pakai tiap hari, jangan biarkan geser',f2p:'CAP Lv20 (pas 4 Pet Adventure/hari). Lebih = boros',pri:'B'},
...
const EVENTS_INFO=[
 {g:'Rutin (harian / mingguan)', items:[
   ...
   {n:'Hall of Heroes',cat:'PvE \u00b7 hero',freq:'~3 hari',what:'Event MINGGUAN: mulai Minggu, berakhir Selasa (bisa belum muncul di server sangat baru, tapi begitu mulai ia jadi rutin). Isinya shard & widget SELURUH generasi lama; untuk generasi berjalan hanya 1 dari 3 hero yang tersedia dan TANPA widget generasi itu. ⚠ Mata uangnya Mark of Valor, dan TIAP GENERASI punya jenis Mark sendiri yang hanya laku di toko generasi itu — Mark tidak bisa ditabung ke generasi berikutnya dan tidak bisa di-upgrade. Habiskan sebelum generasimu berganti, kalau tidak hangus. Sumber shard Marlin untuk F2P.'},
 ]},
 {g:'Aliansi & PvP besar', items:[
   ...
   {n:'Sanctuary Battle',cat:'Aliansi \u00b7 season',freq:'Per season (8 fase)',what:'PvP aliansi mingguan memperebutkan bangunan peta yang memberi buff & hadiah ke SELURUH anggota aliansi. Musimnya 8 fase (tiap fase = satu minggu) dan performa kumulatif menentukan hadiah musim. R5/R4 yang mendaftarkan; per ronde satu aliansi boleh mendaftar 1 Sanctuary + 1 Fortress. ✅ Kalau aliansimu MENANG ronde lalu, ia otomatis didaftarkan untuk MEMPERTAHANKAN, dan pendaftaran otomatis itu TIDAK memakan jatah — jadi bisa menahan satu sambil merebut satu lagi. Untuk menguasai penuh, bangunan harus DITAHAN 30 MENIT BERTURUT-TURUT selama jendela tempur 2 jam. Tingkatannya: Outpost (paling mudah, buff kecil, TANPA season point) ‹ Sanctuary (hadiah lebih baik + season point) ‹ Fortress (tertinggi). Peserta pertama kali hanya boleh mendaftar SATU Sanctuary atau Outpost. Di awal umur kingdom semuanya masih ber-shield dan tak bisa diserang. F2P: jadi JOINER rally, bawa hero Lethality di slot-1; combat-nya RPS (counter unit).',sit:'sanctuary'},
   {n:'Fortress Battle',cat:'Aliansi \u00b7 season',freq:'Per season',what:'Tingkat TERTINGGI dari perebutan bangunan peta \u2014 bernilai 2 season point per rebutan (Sanctuary lebih kecil, Outpost nol). Aturannya sama dengan Sanctuary: R5/R4 mendaftar, per ronde 1 Sanctuary + 1 Fortress, pemenang ronde lalu otomatis didaftarkan bertahan TANPA memakan jatah, dan penguasaan penuh menuntut bangunan DITAHAN 30 MENIT BERTURUT-TURUT dalam jendela tempur 2 jam. Karena itu Fortress hampir selalu jadi rebutan beberapa aliansi sekaligus. F2P: butuh koordinasi penuh \u2014 ikut rally sesuai panggilan R4/R5, jangan menyerang sendiri.',sit:'fortress'},
 ...
 {g:'Aliansi mingguan & PvP rutin', items:[
   ...
   {n:'Hero Rally (bos aliansi)',cat:'Aliansi \u00b7 PvE',freq:'Berkala',what:'Rally bareng kalahkan bos hero. Joiner bawa hero ber-Lethality, kirim troop terkuat.'},
 ...
 {g:'Event rotasi "spend -> hadiah" (kebanyakan 2 hari)', items:[
   ...
   {n:'Officer Project',cat:'aliansi',freq:'2 hari',what:'Event 2 hari yang SELALU mulai hari Rabu atau Minggu. Ada 4 milestone plus papan peringkat Honor. Jenisnya berganti-ganti — tiap varian punya daftar task & milestone berbeda (Type 2 = Charm Design, mulai Minggu), jadi buka tab-nya dulu sebelum menabung barang. Contoh bobot: 1 Forgehammer = 6.000 poin. F2P: kerjakan yang gratis; baru buang tabungan kalau varian yang keluar memang cocok dengan stokmu.'},
   {n:'Stand of Arms',cat:'combat',freq:'2 hari',what:'Event Gen 1 SAJA — tidak muncul lagi di Gen 2+. Irregular, 2 hari, muncul awal umur kingdom. Hanya 3 task, fokusnya memperkenalkan Governor Gear Charm & Forgehammer: 5 poin per 1 skor Governor Gear Charm. F2P: kerjakan yang gratis, jangan beli material demi event sekali lewat ini.'},
   {n:'Grow Your Heroes',cat:'hero',freq:'2 hari',what:'Event Gen 1 SAJA — tidak muncul lagi di Gen 2+. Irregular, 2 hari, muncul awal umur kingdom. Hanya 3 task, semuanya soal meningkatkan hero. F2P: simpan Hero XP & manual skill yang memang sudah direncanakan lalu habiskan di dalam window — jangan beli apa pun demi event sekali lewat ini.'},
   {n:'City Development',cat:'build',freq:'2 hari',what:'Event Gen 1 SAJA — tidak muncul lagi di Gen 2+. Irregular (tak bisa diprediksi), 2 hari, muncul awal umur kingdom. Hanya 4 task. ⚠ KOREKSI: poinnya BUKAN dari kenaikan power bangunan melainkan dari MENIT speedup — 1 poin per 1 menit speedup Construction, Research, atau Training (kingshotwiki). F2P: tahan speedup, habiskan di dalam window.'},
   ...
   {n:'Develop New Tech (rotasi)',cat:'research',freq:'rotasi',what:'Event Gen 1 SAJA — tidak muncul lagi di Gen 2+. Irregular, 2 hari, muncul awal umur kingdom, dan hanya punya 1 task: mendorong kemajuan riset. F2P: tahan speedup research lalu habiskan di dalam window. (Jangan tertukar dengan sub-event harian bernama sama yang muncul setelah reset — itu event berbeda.)'},
   {n:'Working Overtime',cat:'produksi',freq:'rotasi',what:'Event Gen 1 SAJA — tidak muncul lagi di Gen 2+. Irregular (wiki: tak bisa diprediksi), 2 hari, muncul awal umur kingdom. Hanya 2 task, dan skornya sama seperti Power Up: 1 poin per 1 MENIT speedup Construction/Research. F2P: tahan speedup, habiskan di dalam window.'},
   {n:'Path of Growth',cat:'progres',freq:'~7 hari',what:'Event PEMULA: mulai hari pertama server, berjalan 7 hari. Tiap hari selama 5 hari pertama membuka 3 jenis misi BARU — jadi jangan panik kalau daftarnya terlihat pendek di hari pertama. Tiap misi memberi hadiah poin sekaligus barang; sebagian hadiah (mis. shard Jabel) baru terbuka kalau level VIP-mu naik. F2P: kerjakan berurutan, hadiahnya bertingkat.'},
   {n:'Champion\u2019s Way',cat:'progres',freq:'~3 hari',what:'Pengganti Desert Trial mulai Gen 4 — 3 hari, tiap 2 minggu. Loop-nya sama: buru beast di MAP pakai stamina → Weapon Scrap + Precious Keepsake (gem, stamina, speedup, Hero XP) → pakai scrap untuk rally Cesare’s Elite Rebel → peti milestone di 1/3/5/7/10 kill (shard Mythic, Hero XP, Lucky Hero Gear Chest, Forgehammer). BEDA dari Desert Trial: scrap bisa langsung ditukar TANPA maks-kan hero dulu, dan jumlah rally yang kamu luncurkan tak dibatasi. Ikut rally aliansi: maks 50 hadiah partisipasi/hari.'},
   {n:'Merchant Empire',cat:'gather/dagang',freq:'7 hari',what:'Bulanan, menempel pada Alliance Brawl (kalau kingdommu tak memenuhi syarat Brawl, ia jalan sendiri), dan biasanya SETELAH Kingdom of Power. Tugasnya mengawal karavan jarahan ke tujuan dengan march-mu atau march bantuan dari aliansi. Poin bergantung KELANGKAAN karavan — ada 4 tingkat. F2P: kawal karavan langka lebih dulu, minta bantuan aliansi untuk yang jauh.'},
   ...
   {n:'Golden Glaives',cat:'combat',freq:'3 hari',what:'Event PvE 3 hari yang MULAI BARENGAN Strongest Governor & KvK — jadi jadwalnya menempel pada keduanya. Isinya ringan: selesaikan Intel Mission. F2P: dahulukan reward bernilai tinggi sebelum mengejar resource tambahan. Untuk R4/R5: jaga rasio resource aliansi di sekitar 4:4:2:1 (wood:food:stone:iron).'},
   ...
   {n:'Cesares Fury',cat:'aliansi · rebel hunt',freq:'bulanan',what:'Buru rebel di peta (level 1→50, pilih 1 kesulitan/run). Stamina: cari rebel 15 · solo 10 (8 dengan Diana) · rally 25 (20 dengan Diana) — Diana memotong 20%, jadi hematnya 2 di solo tapi 5 di rally. Full clear 50 level ~1.150 stamina DENGAN Diana (~1.250 tanpa). ✅ SOLO DULU sebelum rally/minta bantuan: kalau solo KALAH, stamina dikembalikan 100%. Reward rally cuma dihitung maks 7×/hari. 5 tingkat kesulitan (Easy→Insane), semua mulai dari Easy. F2P: SELALU bawa Diana (hemat stamina); simpan 5 "Cesare’s Accord" (dapat 5 lagi kalau kamu membantu pemain lain) (tip: pakai di stage kelipatan-10 utk bonus shard — bukan aturan keras, bisa di stage mana pun yg tak bisa di-clear); ke Captain kirim 1 troop TANPA hero dulu biar semua anggota dapat reward, baru all-in. Reward: shard Mythic + Gem + speedup. Trap: jangan pilih kesulitan di atas power (terkunci, 1 run/event).'},
   {n:'Beast Whisperer',cat:'PET \u00b7 sekali jalan',freq:'7 hari \u00b7 SEKALI seumur kingdom (~H55)',what:'⚠ KOREKSI: ini BUKAN event berburu beast yang berulang, melainkan event PET SEKALI SEUMUR KINGDOM. Terbuka saat pet Generasi 1 muncul (~hari 55) dan butuh sekitar TC18+. Berjalan 7 hari dengan pola seperti Path of Growth: task baru terbuka tiap hari sampai hari ke-5. Hadiahnya semuanya pet — Pet Refinement Stone, Pet Food, Nutrient Potion (mis. 50 token = 10 potion, 70 token = 15 potion). F2P: kerjakan sampai habis, ini tak akan datang lagi.'},
   {n:'Defeat Nearby Beasts',cat:'PvE',freq:'2 hari',what:'Event 2 hari. Bobotnya jelas: beast Lv1-30 = 1 poin, Terror Lv1-8 = 3 POIN — jadi satu Terror setara tiga beast. Hadiah berbentuk milestone. Barengkan dengan hari kamu memang berencana menghabiskan stamina; satu hunt yang sama bisa dibayar event ini SEKALIGUS Desert Trial / Champion’s Way / stage Beast Slay HoG. 💡 Hitungan sederhana dari ongkos stamina: beast solo 10 stamina untuk 1 poin, sedangkan Terror perlu rally 25 stamina untuk 3 poin — dan IKUT rally Terror orang lain GRATIS. Jadi cara paling hemat: ikut rally Terror aliansi sebanyak mungkin, baru sisanya untuk beast solo.'},
   ...
   {n:'Mystic Divination',cat:'chance',freq:'berkala',what:'Event SOLO tiap 4 minggu, 2 hari. Kamu memilih satu “wish reward” di awal; kartunya diacak Petra bersama 9 kartu hadiah kecil (total 10). ⚠ Peluangnya BUKAN 1/10 — makin bagus hadiahnya makin kecil peluangnya, dan wish reward mulai sekitar 0,5%. Membuka kartu butuh Fortune Token: 1 gratis per hari event + 22 per hari dari daily mission, sisanya berbayar. F2P: pakai token gratis saja — peluang 0,5% bukan tempat membuang uang.'},
   {n:'Champagne Fair',cat:'belanja',freq:'berkala',what:'"Unlock F2P sesungguhnya" (muncul ~setelah HoG ke-3, ~bulanan). Tukar shard hero yang SUDAH max-level + skill book surplus → Voucher → Widget/Mithril/Forgehammer/gear. Shard cuma bisa di-scrap kalau heronya max → hoard shard hero yang belum jadi. Tabung Platinum/Gold Key untuk fair ini. ✅ Fair Voucher TIDAK PERNAH kedaluwarsa dan boleh disimpan untuk fair berikutnya — jadi tak perlu panik menghabiskannya di fair yang penawarannya kurang cocok. Ambang tukarnya 200-300-400-500 voucher tergantung generasi.'},
   {n:'Call of the Sovereign',cat:'engagement',freq:'~3 hari',what:'Event 3 hari: tiap hari ada task yang memberi Glory Point, dan peti terbuka di ambang 10 · 30 · 50 · 80 · 110 Glory Point. Task-nya sebagian besar PvE dan ramah F2P — contoh sebelum Gen 3: bunuh 5 beast = 2 GP (+10rb Hero XP, bread & wood), bunuh 15 beast = 4 GP (+2 Mythic Expedition Manual, speedup). F2P: karena isinya beast, barengkan dengan hari kamu memang berencana menghabiskan stamina — satu hunt bisa dibayar event ini SEKALIGUS Desert Trial/Defeat Nearby Beasts.'},
   {n:'Arcane Trove / Emporium of Enigma',cat:'chest/toko',freq:'berkala',what:'⚠ Ini event DEAL BERBAYAR, bukan event poin. Diakses lewat tab “Deal” → “Arcane Trove”: 5 pack per hari yang saling terhubung seperti pipa — membeli satu membuka berikutnya, dan struktur itu memang dirancang menarikmu terus membeli. F2P: lewati; tak ada jalur gratis berarti di sini.'},
   ...
   {n:'Eternity\u2019s Reach',cat:'solo',freq:'berkala',what:'Event kompetitif SOLO 30 menit, dua mingguan, SELALU hari SELASA, ~100 pemain per medan. ⚠ WAJIB REGISTRASI minimal 15 menit sebelum medan buka. Terlewat? JANGAN memaksa — daftar ke slot berikutnya. ⭐ URUTAN SKILL menentukan seluruh hasilmu: KANAN-KANAN-KIRI-KIRI-KANAN. (1) Cesare beri 1.500 copper · (2) march speed +15% · (3) KUNCI: dapat 5.000 copper tiap menduduki vein biasa, cooldown 1 menit · (4) efisiensi gather copper +15% · (5) kecepatan gather +50% selama 60 detik. Jalur lain fokus tempur — hindari kecuali kamu pemain terkuat. ▶ FASE 1 (sebelum Skill 3 terbuka): SEMUA march serang Cesare terus-menerus, ABAIKAN gathering sepenuhnya. Pilih Cesare yang belum diincar orang. Gathering awal nyaris tak berpoin dan cuma memperlambat Skill 3. ▶ FASE 2 (Skill 3 terbuka — di sinilah kebanyakan orang gagal): 2 march TERLEMAH tetap di Cesare, 3-4 march TERKUAT ke vein. Kuncinya kamu gather BUKAN untuk resource, tapi untuk memicu bonus: kirim → tunggu ~60 detik → TARIK MANUAL → kirim lagi. Ulangi terus. Loop inilah tulang punggung skor F2P tinggi. ▶ FASE 3 (Vein Outburst): Skill 5 HANYA dipakai saat outburst — perlakukan sebagai pengali 1 menit. Saat aktif: semua march gather, JANGAN ditarik, biarkan satu menit penuh. Memakainya di luar outburst membuang cooldown 5 menit. 💠 Fractured Vein = 4.000 poin, gather 200/detik — begitu peringatannya muncul, tinggalkan semua dan serbu. Tingkat vein berlipat: Lv3 ≈ 4× Lv1. Peak of Eternity (tengah) poin pasif tertinggi tapi magnet whale; top-10 lama pendudukan dapat bonus akhir. 🏰 Siapkan: 5-6 march PENUH (march separuh membuang efisiensi), Cesare TIDAK menyebabkan korban jadi tak perlu healing, dan saat dapat teleport gratis pindah ke sudut sepi dengan kota menempel 2-3 vein biar march-nya pendek.'},
   ...
   {n:'Truegold Refinement',cat:'Truegold \u00b7 Deals',freq:'barengan All-Out',what:'Kumpul Lesser Truegold \u2192 tukar pack Truegold (tab DEALS, selalu barengan All-Out; butuh Age of Truegold). F2P: Lesser Truegold gratis dari gather 25M (\u00d75) + habiskan 50 stamina (\u00d75) \u2014 itu SEMUA yang gratis; sumber ketiga di wiki adalah pack berbayar. CARRY-OVER \u2192 tabung ke pack besar. Trap: gather tak peduli rasio \u2192 pakai gather-boost di bread/wood.'},
   ...
   {n:'Imperial Consortium',cat:'pack BERBAYAR',freq:'2 hari',what:'Event berbayar 2 hari berupa tangga pack ($0.99-99.99) \u2014 beli tier rendah dulu untuk membuka tier atas. F2P: SKIP (spend-only); paling banter pack termurah kalau routenya kasih mat charm/gear yang kamu butuh. Trap: didesain merantai pembelian, gampang boros.'},
   /* KOREKSI, diverifikasi 31 Jul 2026. Tiga entri di bawah dulu ditulis sebagai EVENT
      POIN lengkap dengan strategi F2P. Dua sumber berdiri sendiri menyatakan ketiganya
      PACK BERBAYAR: fam1245.com (Kingshot Field Manual, kalender 4-minggu hasil ekspor
      game — mendaftarkannya di bagian "Packs available today" dengan jendela hari
      sendiri) dan topuplive.com/news/kingshot-packs ("Governor Gear Enhancement Packs",
      "Charm Craftsman Packs"). Kekeliruannya sekelas Treasure Cove yang sudah dikoreksi
      lebih dulu: nama yang terdengar seperti event poin, padahal etalase.
      Poin charm & gear yang dulu dilekatkan ke sini SEBENARNYA milik event lain —
      fam1245: "Stand of Arms includes Governor Gear Charm score and Forgehammers" dan
      "Officer Project can score Governor Gear, Governor Gear Charm score... depending on
      type". Jadi angkanya tidak dibuang, cuma dikembalikan ke tempatnya. */
   {n:'Truegold Wonders',cat:'PACK berbayar',freq:'jendela pack (mis. Sen-Sab)',what:'⚠ KOREKSI: ini PACK BERBAYAR, bukan event poin. Ia muncul di jendela pack (fam1245 mencatatnya Senin-Sabtu), bukan sebagai papan milestone yang bisa digrind gratis. F2P: SKIP. Kalau kamu memang mau menghabiskan Truegold, lakukan di window scoring yang NYATA — Strongest Governor, Officer Project, Armament Competition, atau Kingdom of Power — bukan demi pack ini. Trap: namanya terdengar seperti event milestone; tetap jangan sebar Truegold tipis ke banyak gedung.'},
   {n:'Charm Craftsman',cat:'PACK berbayar',freq:'jendela pack (mis. Rab-Kam)',what:'⚠ KOREKSI: ini PACK BERBAYAR, bukan event poin. F2P: SKIP. Poin dari menaikkan Governor Charm itu ADA, tapi bukan di sini — yang membayarnya Stand of Arms (Governor Gear Charm score + Forgehammer) dan Officer Project Type 2 (Charm Designs, mulai Minggu). Simpan Charm Guide/Design untuk salah satu window itu. Tips charm yang tetap berlaku: konsentrasi, jangan ratakan 6 slot (level awal lompatan stat paling besar, L1=+9%), dan jangan habiskan design sehari sebelum window.'},
   {n:'Treasure Cove',cat:'PACK berbayar',freq:'5 hari',what:'⚠ BUKAN grind poin gratis — event peta 7 hari, fragmennya dibuka dengan BELI "Treasure Cove Pack" (spender). F2P: klaim HANYA chest login harian Gratis (ikon terpisah, ada titik merah), selain itu SKIP. Trap: jangan kejar progress bar (butuh pack); grand prize via mail bisa hadiah default, bukan pilihanmu.'},
   /* Yang SATU ini bertahan sebagai event, bukan pack: kalender fam1245 memunculkannya
      berulang di baris hari (bukan di daftar "Packs available today"), dan ia menempel
      pada Alliance Brawl / Hope Market. Yang masih belum terbit cuma tabel poinnya —
      penandanya dipersempit, bukan dihapus. Diverifikasi 31 Jul 2026. */
   {n:'Top Governor — Governor Gear',cat:'PACK berbayar',freq:'jendela pack Jum-Min',what:'⚠ KOREKSI KEDUA: sempat kupertahankan sebagai event poin, dan itu KELIRU. Feed kalender resmi kingshot.net — yang app ini sendiri pakai — menandainya type:PACK, isMainEvent:false, jendela Jumat-Minggu. Tak ada entri non-PACK bernama ini; event aslinya adalah Strongest Governor (COMPETITION, Senin-Minggu). Jadi ini pack bertema, bukan papan poin. F2P: SKIP. Kalau mau menghabiskan mat Governor Gear demi POIN, lakukan di Strongest Governor, Officer Project, atau Armament Competition. Trap: jangan buang mat premium (Satin/Gilded/Artisan) ke upgrade marginal cuma karena pack ini muncul.'},
   {n:'Governor Gear Enhancement / Enhance Gear',cat:'PACK berbayar',freq:'jendela pack (mis. Jum-Min)',what:'⚠ KOREKSI: ini PACK BERBAYAR, bukan event poin. F2P: SKIP. Yang membayar Forgehammer sebagai POIN adalah keluarga Stand of Arms (~800 poin/Forgehammer) dan Officer Project — tabung Forgehammer untuk salah satu window itu, bukan untuk pack ini. Catatan gear yang tetap berlaku: fokus 1 hero rally utama, kejar Tier 6+ (Tier 1-5 nyaris sia-sia), dan ⛔ jangan buang speedup di sini. ⚠ Awas dua hal berbeda: Forgehammer/Mithril itu HERO Gear, sedangkan GOVERNOR Gear pakai Satin/Gilded/Artisan.'},
   {n:'Custom Selection',cat:'PACK berbayar',freq:'jendela pack',what:'PACK berbayar: kamu memilih sendiri isi paketnya. F2P: SKIP. (terdaftar type:PACK di feed kalender resmi kingshot.net, diverifikasi 31 Jul 2026 — didaftarkan di sini supaya tidak terbaca sebagai peluang gratis yang terlewat.)'},
   {n:'Hope Market',cat:'PACK berbayar',freq:'jendela pack',what:'PACK berbayar berbentuk etalase. F2P: SKIP — tak ada jalur gratis berarti. (terdaftar type:PACK di feed kalender resmi kingshot.net, diverifikasi 31 Jul 2026 — didaftarkan di sini supaya tidak terbaca sebagai peluang gratis yang terlewat.)'},
   {n:'Combat Medic',cat:'PACK berbayar',freq:'jendela pack',what:'PACK berbayar bertema penyembuhan pasukan. F2P: SKIP; kosongkan infirmary dengan speedup heal biasa. (terdaftar type:PACK di feed kalender resmi kingshot.net, diverifikasi 31 Jul 2026 — didaftarkan di sini supaya tidak terbaca sebagai peluang gratis yang terlewat.)'},
   {n:'Custom Forging Set',cat:'PACK berbayar',freq:'jendela pack',what:'PACK berbayar material forging (Hero Gear). F2P: SKIP — tabung Forgehammer untuk window Stand of Arms/Officer Project. (terdaftar type:PACK di feed kalender resmi kingshot.net, diverifikasi 31 Jul 2026 — didaftarkan di sini supaya tidak terbaca sebagai peluang gratis yang terlewat.)'},
   {n:'Governor Stamina',cat:'PACK berbayar',freq:'jendela pack',what:'PACK berbayar berisi stamina. F2P: SKIP — stamina gratis sudah ~528/hari dari regen + Storehouse. (terdaftar type:PACK di feed kalender resmi kingshot.net, diverifikasi 31 Jul 2026 — didaftarkan di sini supaya tidak terbaca sebagai peluang gratis yang terlewat.)'},
   {n:'Troop Training',cat:'PACK berbayar',freq:'jendela pack',what:'PACK berbayar bertema latih/promote troop. F2P: SKIP; latih troop di window scoring (SG/KvK/Officer Project), bukan demi pack. (terdaftar type:PACK di feed kalender resmi kingshot.net, diverifikasi 31 Jul 2026 — didaftarkan di sini supaya tidak terbaca sebagai peluang gratis yang terlewat.)'},
   {n:'Jeweler\'s Collection',cat:'PACK berbayar',freq:'jendela pack',what:'PACK berbayar bertema permata/gem. F2P: SKIP. (terdaftar type:PACK di feed kalender resmi kingshot.net, diverifikasi 31 Jul 2026 — didaftarkan di sini supaya tidak terbaca sebagai peluang gratis yang terlewat.)'},
 ...
 {g:'Berkala / khusus', items:[
   ...
   {n:'Hero Rally (sub-event rekrut hero)',cat:'hero \u00b7 sub-event',freq:'berkala (cek in-game)',what:'Poin dari rekrut/naikkan hero. F2P: klaim recruitment gratis; pakai shard yang memang sudah direncanakan. JANGAN spend gem khusus event ini \u2014 gem paling bernilai di Hero Roulette saat HoG D2 (90.000/spin).'},
   ...
   {n:'Develop New Tech (sub-event harian)',cat:'harian \u00b7 setelah reset',freq:'harian (reset 07:00 WIB)',what:'Sub-event harian: poin dari mulai/selesaikan riset. Mulai riset SETELAH reset biar kehitung; barengkan riset besar dengan hari riset HoG/SG/KvK biar poinnya dobel.'},
   {n:'Power Up — catatan koreksi',cat:'koreksi data',freq:'berkala (obs. pertama ~H18, Kingdom #2114)',what:'\u26a0 KOREKSI: entri ini dulu menyebut poin datang dari AMBANG POWER \u2014 itu keliru dan bertentangan dengan entri Power Up satunya. kingshotwiki: poin datang dari MENIT speedup konstruksi/riset (1 poin/menit), event Gen 1 SAJA, irregular, 2 hari, 3 task. Kemungkinan dulu tertukar dengan Burst of Life yang memang berbasis power. Lihat entri "Power Up" di grup rotasi.'},
 ]},
];
...
const EVENT_TEMPLATES={
  kvk:{name:'Kingdom of Power (KvK)',len:5,battleWIB:'19:00 WIB',minDay:70,
    ...
    hold:'speedup (semua), gem, Mythic shard, Truegold, Mithril, Forgehammer, Advanced Taming Mark, troop T9 + Training Capacity buff utk promote',holdEN:"speedups (all kinds), gems, Mythic shards, Truegold, Mithril, Forgehammer, Advanced Taming Marks, T9 troops + Training Capacity buff for promoting"},
  sg:{name:'Strongest Governor',len:7,battleWIB:null,minDay:75,
    ...
    hold:'speedup (utk D1/D5/D7), Mithril (D2/D4/D5), Advanced Taming Mark (D3), troop T9 + Training Capacity buff (D4/D6), gem',holdEN:"speedups (for D1/D5/D7), Mithril (D2/D4/D5), Advanced Taming Mark (D3), T9 troops + Training Capacity buff (D4/D6), gems"},
  hog:{name:'Hall of Governors',len:7,battleWIB:null,
    ...
    hold:'gem + Widget (utk D2 & D5 = 90rb & 100rb!), troop T9 + Training Capacity buff (D3), Charm design (D4), Forgehammer (D5), speedup (D7)',holdEN:"gems + Widgets (for D2 & D5 = 90k & 100k!), T9 troops + Training Capacity buff (D3), Charm designs (D4), Forgehammer (D5), speedups (D7)"},
  armament:{name:'Armament Competition',len:2,battleWIB:null,minDay:65,
    ...
    hold:'Forgehammer, Mithril, shard, Truegold. \u26d4 JANGAN buang speedup di sini (1 poin/mnt)!',holdEN:"Forgehammer, Mithril, shards, Truegold. ⛔ DO NOT dump speedups here (1 point/minute)!"},
...
const EV_LANGKAH={
  ...
  allianceChampionship:{sumber:'kingshotwiki.com/events/alliance-championship',verif:'terverifikasi 9 Agu 2026',
    langkah:[
      'Mingguan: Senin 00:00 UTC sampai Senin berikutnya, lima fase. Pendaftaran dibuka Senin 00:00 dan TUTUP Rabu 23:00 UTC — syarat TC10 ke atas.',
      'JEBAKAN TERBESAR: pendaftaran mengambil SNAPSHOT march-mu beserta semua buff yang sedang aktif. Daftarlah saat pet & buff menyala — snapshot itu tetap terpakai walau buffnya sudah habis. Tapi begitu kamu "update" tim, snapshot lamanya hilang.',
      'Tiga lane, masing-masing 20 orang (total 60). Aliansi butuh minimal 10 pendaftar supaya bisa masuk matchmaking (Rabu 23:00 → Kamis 00:00 UTC).',
      'Kamu TIDAK perlu online saat bertempur. Lima ronde @1 jam berjalan otomatis dari susunan fase persiapan; event tutup Sabtu 12:00 UTC.',
      'Untuk R4/R5: menang 2-1 lebih aman daripada mengejar sapu bersih — tumpuk 40 pemain terkuat di dua lane dan relakan satu lane.']},
  allianceBrawl:{sumber:'kingshotwiki.com/events/alliance-brawl',verif:'terverifikasi 9 Agu 2026',
    langkah:[
      'Berlangsung 6,5 hari (lima hari penuh + hari terakhir 36 jam) dan mulai tepat SESUDAH KvK.',
      'Kamu harus sudah berada di aliansi SEBELUM matchmaking, dan aliansimu harus masuk 20 besar power di kingdom. Bergabung telat tidak dihitung.',
      'Tema hariannya: Rise of the City · Hero Development · Pet Training · Gear Enhancement · Trade Baron · Full-Scale Competition. Tabung item sesuai tema besok, bukan dipakai hari ini.',
      'Ada 13 horn diperebutkan (hari pertama 1 horn, 1,5 hari terakhir 4 horn). Aliansi menang kalau mengumpulkan 7 horn atau lebih — jadi hari terakhir menentukan.']},
  goldenGlaives:{sumber:'kingshotwiki.com/events/golden-glaives',verif:'terverifikasi 9 Agu 2026',
    langkah:[
      'PvE 3 hari yang mulai BERSAMAAN dengan Strongest Governor dan KvK — jadwalnya menempel pada keduanya.',
      'Isinya ringan: selesaikan Intel Mission untuk mengumpulkan goldstone selama dua hari pertama (misi normal 1 dim, golden glaives 10 dim).',
      'Tukarkan goldstone SEBELUM hari ketiga berakhir. Yang tidak ditukar berubah jadi 10.000 bread — nyaris tak berharga.',
      'F2P: dahulukan hadiah bernilai tinggi, resource belakangan. Kalau punya akun farm, justru sebaliknya.']},
  swordlandShowdown:{sumber:'kingshotwiki.com/events/swordland-showdown',verif:'terverifikasi 9 Agu 2026',
    langkah:[
      'Dua-mingguan, selalu MINGGU. Tiga tahap: voting slot waktu → sign-up 2 hari → pertempuran.',
      'Batas 30 peserta per legion. Sepuluh cadangan baru boleh masuk setelah 3 menit, itupun hanya mengisi slot yang kosong — siapa cepat dia dapat.',
      'Legion 1 harus diisi pemain terkuat: hasilnya menentukan hadiah SELURUH anggota aliansi, bukan cuma yang ikut.',
      'Peringkat (Supreme/Master/Platinum/Gold) dihitung dari rata-rata power 20 pendaftar terkuat, dan hadiah naik mengikuti peringkat.',
      'Di zona spawn kamu tak bisa diserang TAPI bisa menyerang keluar — satu-satunya tempat seperti itu di game. Manfaatkan.',
      'Nilai bangunan dari tertinggi: Swordshrine → Sanctum → Abbey. Setengah poin aliansi tersimpan DI DALAM bangunan dan jatuh jadi paket saat bangunan berpindah tangan — rebut paketnya, atau incar bangunan musuh yang tumpukannya sudah besar.',
      'Undercellar cuma gathering biasa dan sering dilupakan orang — jalur poin yang aman kalau kamu kalah kuat.',
      'Keluar aliansi sebelum fase sign-up berakhir = tidak bisa ikut sama sekali.']},
  triAllianceClash:{sumber:'kingshotwiki.com/events/tri-alliance-clash',verif:'terverifikasi 9 Agu 2026',
    langkah:[
      'Lintas-kingdom tiap empat minggu; tiga aliansi diadu sekaligus.',
      'Empat fase berurutan: Persiapan 3 menit → Seize & Conquer 17 menit → Garrison Occupation 20 menit → Temple Onslaught 20 menit.',
      'Temple of Tides bernilai 1.800 poin PER MENIT — fase terakhir itulah yang menentukan pemenang, bukan penguasaan awal.',
      'Fase awal tetap penting: bangunan yang direbut lebih dulu menentukan kestabilan sampai akhir.']},
  champagneFair:{sumber:'kingshotwiki.com/events/champagne-fair',verif:'terverifikasi 9 Agu 2026',
    langkah:[
      'Dua hari, terbuka setelah kamu menyelesaikan Hall of Governors ke-3, dan kembali sekitar sebulan sekali.',
      'Gunanya menukar barang mubazir — shard hero berlebih, widget, skill book — menjadi Fair Voucher.',
      'Fair Voucher TIDAK PERNAH kedaluwarsa. Boleh ditabung untuk fair berikutnya kalau penukaran sekarang tidak menarik.',
      'Widget harus dibuka dari cratenya DULU sebelum bisa ditukar (200-500 voucher tergantung generasi, batas 100).']},
  mysticDivination:{sumber:'kingshotwiki.com/events/mystic-divination',verif:'terverifikasi 9 Agu 2026',
    langkah:[
      'Solo, tiap empat minggu, dua hari. Pilih satu "wish reward", lalu cari kartunya di antara 10 kartu.',
      'Peluangnya BUKAN 1/10: makin bagus hadiahnya makin kecil peluangnya — wish reward mulai dari 0,5%.',
      'Biaya Fortune Token per flip naik terus: 1 · 2 · 3 · 4 · 6 · 8 · 12 · 15 · 20 · 25 (total 96 kalau semua kartu dibuka).',
      'Token gratis: 1 per hari event, plus 22 per hari dari misi harian.',
      'Begitu wish reward ketemu kamu dapat reset gratis — JANGAN teruskan membuka kartu sisanya, tidak pernah menguntungkan.',
      'Tiap ronde dijamin ada satu kartu "x2"; membukanya sebelum wish reward adalah skenario terbaik.',
      'Milestone di 20, 100, 250, dan 750 token terpakai. Token sisa tetap tinggal di tas setelah event tutup.']},
  fishing:{sumber:'kingshotwiki.com/events/fishing-tournament',verif:'terverifikasi 9 Agu 2026',
    langkah:[
      'Dua cara memancing: biasa memakai Bait, dan Ocean Prospector memakai Treasure Chart.',
      'Bait: 1 percobaan = 1 bait. Mulai dengan 5, bertambah 1 tiap 3 jam, dan simpanan MENTOK di 10 — pakai sebelum penuh, kalau tidak regenerasinya terbuang.',
      'Ocean Prospector memancing di area khusus berisi ikan langka dan Ocean Chest, dan alat pancingmu otomatis di level penuh di mode itu.']},
  desertTrial:{sumber:'kingshotwiki.com/events/desert-trial',verif:'terverifikasi 9 Agu 2026',
    langkah:[
      'Dua-mingguan, 3 hari. Misi utamanya: buru 10 Dreadwolf — dan kamu harus MEMULAI rally-nya sendiri, ikut rally orang lain tidak dihitung.',
      'Selesai 10 Dreadwolf = 10 shard Diana. Diana memangkas pemakaian stamina untuk hunt & rally, dan mempercepat march.',
      'Clawshard: JANGAN buru-buru ditukar Challenger Pouch. Pakai dulu untuk membawa Diana ke 5 bintang; sesudah itu barulah clawshard sisa berguna untuk berburu shard tambahan di luar event (maks 500 shard Diana per event).',
      'Event ini hilang di Gen 4, diganti Champion’s Way — jadi kejar Diana selagi masih ada.']},
