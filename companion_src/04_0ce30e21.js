...
const EVENTS_INFO=[
 ...
 {g:'Aliansi mingguan & PvP rutin', items:[
   ...
   {n:'Alliance Championship / Mobilization',cat:'Aliansi \u00b7 misi',freq:'Berkala',what:'Kumpul poin aliansi dari misi (gather/help/train/spend). Mobilization: ambil refresh GRATIS tiap hari, beli attempt 50 & 200 gem (sering net-profit ~100 gem balik/200 poin), HINDARI attempt 1.000 gem. Championship: snapshot stat LOCK saat registrasi \u2192 nyalakan SEMUA buff sebelum confirm (butuh TC10). Struktur: 6 aliansi/bracket, 5 ronde, 3 LANE; hanya TOP 20 (by power) yang dihitung; menang 2 dari 3 lane = menang ronde; maks 2 kill/member/ronde. Reset Senin (UTC): registrasi 2h + matchmaking 1h + tanding ~3h (11 jam atur lane antar ronde; Ronde 1 buta, lawan terlihat R2+). STRATEGI 2-1: tumpuk pemain terkuat di 2 lane, korbankan 1 (margin kalah tak penting \u2014 yang penting menang 2 lane). Deploy troop SEBELUM tanding (troop yang lagi march/heal/reinforce tak ikut). Tier: Stone\u2192Iron\u2192Bronze\u2192Silver\u2192Gold\u2192Diamond (reward Charm Stone/Forgehammer/Gem/Hero Shard); Championship Badge \u2192 Championship shop.'},
