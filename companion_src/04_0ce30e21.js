...
const EVENTS_INFO=[
 ...
 {g:'Event rotasi "spend -> hadiah" (kebanyakan 2 hari)', items:[
   ...
   {n:'Top Governor — Governor Gear',cat:'poin · gear · ranking',freq:'berulang, menempel Alliance Brawl',what:'Varian Top/Strongest Governor bertema Governor Gear (ranking 7-hari). Terkonfirmasi berulang di kalender dan menempel pada Alliance Brawl / Hope Market. F2P: jadwalkan SATU upgrade Governor Gear/charm yang DITahan agar selesai DI window → poin ranking + milestone. Hold mat gear (Satin/Gilded/Artisan), spend breakpoint di window. Trap: jangan buang mat premium ke upgrade marginal. [tabel poinnya belum pernah terbit — app tidak mengarang angkanya]'},
