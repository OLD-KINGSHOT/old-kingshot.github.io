...
const SITUATIONS=[
 {key:'bear-trap',name:'Bear Trap',sub:'Bear Hunt \u00b7 harian',icon:'\u25c8',kind:'rally',role:'Joiner',evType:'bear',minDay:0,daily:true,pick:1,
  ...
  table:[[',\ud83e� JOINER (kamu ikut rally)','🚩 HOST / rally-lead (R4/R5)'],['Hero','Chenko / Yeonwoo / Amane — slot-1 Lethality (cuma skill #1 dihitung)','1 per KELAS (ke-3 skill berlaku saat host): Amadeus*(Inf) + Chenko(Cav) + Yeonwoo / Amane(Arc). *Amadeus=P2W — F2P tanpa dia: pakai hero infantry ber-skill ofensif terbaik (mis. Quinn > Diana)'],['Troop','Archer-heavy per-gen: 10/30/60 (Gen1) → 1/10/89 (Gen4+)','Sama (archer-heavy per-gen) + MAX kapasitas'],['Pet','—','Mighty Bison (+15k kapasitas) — lebih troop = lebih damage']],
